...
<div class="form-group col-sm-12">
    <div class="box-body table-responsive no-padding"  >
      ...
      <h2>Penjualan dari Tanggal <?php echo e($start); ?> s/d <?php echo e($end); ?></h2>
         ...
         <?php $__currentLoopData = $lapBul; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="form-group col-sm-6 ">
  ...
  <?php echo Form::open(['route'=>'reports.lapBulSheet']); ?>
