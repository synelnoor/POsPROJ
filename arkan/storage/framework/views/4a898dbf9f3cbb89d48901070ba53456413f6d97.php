      ...
      <table class="table table-bordered" id="crud_table" border="3">
          ...
          <tr class="trbody">
            ...
            <?php echo Form::text('row[0][barang_id]', null, ['class' => 'form-control barang_id search_text ','id'=>'barang_id']); ?></td>
             <td contenteditable="true" class="nama_barang" ><?php echo Form::text('row[0][nama_barang]', null, ['class' => 'form-control search_text ','id'=>'nama_barang']); ?></td>
    ...
    var action = document.getElementById("action");
     ...
     $('#add').click(function(){
      ...
      var html_code = "<tr id='row"+count+"' class='trbody'>";
       ...
       html_code += "<td contenteditable='true' class='code_barang'><input type='text' name='row["+count+"][code_barang]' class='form-control' readonly/></td>";

       html_code += "<td contenteditable='true' class='qty' ><input type='text' name='row["+count+"][qty]' class='form-control qty' id='qty'  /></td>";
       html_code += "<td contenteditable='true' class='harga' ><input type='text' name='row["+count+"][harga]' class='form-control harga search_text' id='harga' readonly/></td>";
       html_code += "<td contenteditable='true' class='subtotal' ><input type='text' name='row["+count+"][subtotal]' class='form-control subtotal' id='subtotal' readonly/></td>";
    ...
    var action = '<?php echo @$action; ?>';
       ...
       function additionalTable()
     {
      ...
      document.getElementById("countdetail").value = count;
       ...
       html_code += "<td contenteditable='true' class='barang_id' style='display:none;'><input type='hidden' name='row["+count+"][id]' class='form-control id'/><input type='text' name='row["+count+"][barang_id]' class='form-control barang_id'/><input type='text' name='row["+count+"][order_id]' class='form-control order_id'/></td>";
       html_code += "<td contenteditable='true' class='nama_barang'><input type='text' name='row["+count+"][nama_barang]' class='form-control search_text'/> </td>";
       html_code += "<td contenteditable='true' class='code_barang' readonly><input type='text' name='row["+count+"][code_barang]' class='form-control' readonly/></td>";
