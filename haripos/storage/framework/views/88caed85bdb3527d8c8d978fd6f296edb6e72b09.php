...
<div class="form-group col-sm-6">
    ...
    <?php echo Form::select('status', ['cash' => 'cash', 'pending' => 'pending'], null, ['class' => 'form-control']); ?>
    ...
    <div class="box-body table-responsive no-padding"  >
      <table class="table table-bordered" id="crud_table" border="3">
          ...
          <tr class="trbody">
            ...
            <td contenteditable="true" class="barang_id" style="display: none;"><?php echo Form::text('row[0][barang_id]', null, ['class' => 'form-control barang_id search_text ','id'=>'barang_id']); ?></td>
            ...
            <td contenteditable="true" class="code_barang">
               <?php echo Form::text('row[0][code_barang]',null,['class'=>'form-control search_text ','id'=>'code_barang']); ?>
            ...
            <td contenteditable="true" class="harga">
              <?php echo Form::text('row[0][harga]',null,['class'=>'form-control harga  ','id'=>'harga']); ?>

             </td>
            <td contenteditable="true" class="subtotal">
                  <?php echo Form::text('row[0][subtotal]',null,['class'=>'form-control subtotal ','id'=>'subtotal']); ?>
