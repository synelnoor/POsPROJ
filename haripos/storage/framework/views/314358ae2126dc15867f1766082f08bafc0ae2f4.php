<div id="extra-wrap">
	<div id="extra" class="clearfix">
	    ...
	    <div class="col-md-4">
		    ...
		    <h3>Kontak info</h3>
        <img class="img-circle" src="<?php echo e(asset('/img/logo.png')); ?>" alt="Generic placeholder image" style="width: 80px; height: 80px;">
            ...
            <ul class="subscribe-stuff">
				...
				<img alt="Facebook" title="Facebook" src=" <?php echo e(asset('/img/sosial_f.png')); ?>" /></a>
			    </li>
           <li><a title="Instagram" href="https://www.instagram.com/fisipmoestopo" rel="nofollow">
        <img alt="Instagram" title="Instagram" src="<?php echo e(asset('/img/sosial_in.png')); ?>" /></a>
          </li>
			    <li><a title="Twitter" href="https://twitter.com/fisip_moestopo" rel="nofollow">
				<img alt="Twitter" title="Twitter" src="<?php echo e(asset('/img/sosial_t.png')); ?>" /></a>
			    </li>
           <li><a title="Youtube" href="https://www.youtube.com/channel/UCgqtiBBfdGMykz5zJA2EFKg" rel="nofollow">
        <img alt="Youtube" title="Youtube" src="<?php echo e(asset('/img/sosial_y.png')); ?>" /></a>
          </li>
			    <li><a title="E-mail this story to a friend!" href="moestopofisip@gmail.com" rel="nofollow">
				<img alt="E-mail this story to a friend!" title="E-mail this story to a friend!" src="<?php echo e(asset('/img/sosial_y.png')); ?>" />
				</a>
			    </li>
            </ul>
